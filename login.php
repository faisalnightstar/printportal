            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-6">
                        <a href="index.php"
                            class="text-gray-300 hover:text-brand-accent px-3 py-2 rounded-md text-sm font-medium transition-colors">Home</a>
                        <a href="service.php"
                        ...
                        <a href="login.php"
                            class="text-brand-accent px-3 py-2 rounded-md text-sm font-bold transition-colors">Login</a>
                        <a href="register.php"
    ...
    <div class="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-gray-100">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-xs text-blue-700 font-medium">
                            <strong>DL Print Available!</strong> Aadhaar to PAN Number search is now instant for just 30
                            Rupees via the admin service.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form class="mt-8 space-y-6" action="" method="POST">
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input id="loginid" name="loginid" type="text" required
                                class="focus:ring-brand-light focus:border-brand-light block w-full pl-10 sm:text-sm border-gray-300 rounded-lg py-3 bg-gray-50 border outline-none transition-colors"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember-me" name="remember-me" type="checkbox"
                            class="h-4 w-4 text-brand-light focus:ring-brand-light border-gray-300 rounded">
                ...
                <div>
                    <button type="submit" name="submit"
                        class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-bold rounded-lg text-white bg-brand-light hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-light transition-colors shadow-md">
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <svg class="h-5 w-5 text-blue-400 group-hover:text-blue-300 transition-colors" fill="none"
            ...
            <div class="mt-6 text-center border-t border-gray-100 pt-6">
                ...
                <a href="register.php"
                    class="w-full flex justify-center py-3 px-4 border-2 border-brand-accent text-sm font-bold rounded-lg text-brand-accent hover:bg-brand-accent hover:text-white transition-all">
                    Create New Account
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mt-8">
                ...
                <div class="flex space-x-4 mt-6 md:mt-0 text-sm">
                    <a href="privacy-policy.php" class="text-gray-500 hover:text-brand-light transition-colors">Privacy
                        Policy</a>
                    <a href="refund-policy.php"
                        class="text-gray-500 hover:text-brand-light transition-colors">Refund/Cancellation</a>
                    <a href="Terms.php" class="text-gray-500 hover:text-brand-light transition-colors">Terms &
                        Conditions</a>
                </div>
            </div>
        </div>
