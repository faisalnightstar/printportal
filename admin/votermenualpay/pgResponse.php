...
$query = "UPDATE voterauto0 SET payment_status=1 WHERE voterautoid='$userid'";
...
echo $html
   ...
   <script>
            setTimeout(()=>{
                window.location.href="https://<?php echo $server=$_SERVER['SERVER_NAME'];?>/admin/votermanuallist.php";
            },2000);
        </script>
        <?php 
