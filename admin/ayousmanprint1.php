...
<div class="modal fade" id="proc_modal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<center>
				<img src="https://mybestprint.in/logo1.png">
...
echo $v = file_get_contents('https://test.axenapi.co.in/Dashboard/Verify_api/ayushman/ay_o_p.php?'.$type.'='.$flno.'&stateid='.$stid.'&domain='.$domain.'&api=iZ66rPPf-kZSO-oL59-2CGc-uUSe72HfrrTz3ym1');
 $vk = json_decode($v,true);
  $status=$vk['0']['status'];
 if($status=="no"){
    $sql = "update tbluser SET findwallet= findwallet - 10 where userid='" . $_SESSION[ 'userid' ] . "'";
