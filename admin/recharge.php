...
<div class="recharge-wrapper max-w-7xl mx-auto space-y-6 py-4 px-2">
    ...
    <div class="text-center max-w-3xl mx-auto space-y-2 mb-6">
        <span
            class="inline-block px-3 py-1 bg-blue-100 text-blue-700 text-xs font-extrabold rounded-full uppercase tracking-wider">Account
            Upgrade & Plans</span>
        <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Choose Your Access Tier</h1>
        <p class="text-xs text-slate-600 font-medium">Recharge your portal account instantly using dynamic UPI QR codes.
            Instant automated activation.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-2">
        ...
        <!-- Retailer Plan (₹299) -->
        <div
            class="plan-card rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all flex flex-col justify-between relative overflow-hidden group">
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    <h3 class="plan-title text-lg font-bold">Retailer</h3>
                    <span
                        class="px-2.5 py-0.5 rounded-full bg-slate-100 text-slate-700 text-[11px] font-bold border border-slate-200">Personal
                        Use</span>
                </div>
                ...
                <p class="plan-desc text-xs border-b border-slate-200 pb-4">Ideal for personal print jobs & individual
                    service access.</p>
            ...
            <button onclick="openUpiRechargeModal(299)"
                class="mt-6 w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs rounded-xl shadow-sm transition-colors flex items-center justify-center gap-1.5 cursor-pointer">
        ...
        <div
            class="bg-gradient-to-b from-blue-900 to-slate-900 text-white border-2 border-blue-500 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all flex flex-col justify-between relative overflow-hidden group">
            <div class="absolute top-3 right-3">
                <span
                    class="px-2.5 py-0.5 rounded-full bg-blue-500 text-white text-[10px] font-extrabold shadow-sm uppercase tracking-wider">Popular</span>
            </div>
            ...
            <div class="space-y-4">
                ...
                <p class="text-xs text-blue-200 border-b border-blue-800/80 pb-4">Create unlimited retailer accounts &
                    offer CSC services.</p>
            ...
            <button onclick="openUpiRechargeModal(999)"
                class="mt-6 w-full py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-xl shadow-md shadow-blue-500/20 transition-all flex items-center justify-center gap-1.5 cursor-pointer">
        ...
        <div
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="px-2.5 py-0.5 rounded-full bg-purple-100 text-purple-800 text-[11px] font-bold border border-purple-200">Unlimited</span>
                </div>
                <div class="flex items-baseline">
                    <span class="plan-price text-3xl">₹1499</span>
                    <span class="text-xs text-slate-500 font-medium ml-1">/ one-time</span>
                </div>
                <p class="plan-desc text-xs border-b border-slate-200 pb-4">Unlimited points, Unlimited Retailers &
                    Distributors.</p>
            ...
            <button onclick="openUpiRechargeModal(1499)"
                class="mt-6 w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs rounded-xl shadow-sm transition-colors flex items-center justify-center gap-1.5 cursor-pointer">
        ...
        <div
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="px-2.5 py-0.5 rounded-full bg-amber-100 text-amber-800 text-[11px] font-bold border border-amber-200">Enterprise</span>
                </div>
                <div class="flex items-baseline">
                    <span class="plan-price text-3xl">₹2999</span>
                    <span class="text-xs text-slate-500 font-medium ml-1">/ one-time</span>
                </div>
                <p class="plan-desc text-xs border-b border-slate-200 pb-4">Full admin level access with unlimited users
                    across all tiers.</p>
            ...
            <button onclick="openUpiRechargeModal(2999)"
                class="mt-6 w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs rounded-xl shadow-sm transition-colors flex items-center justify-center gap-1.5 cursor-pointer">
