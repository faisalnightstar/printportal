...
curl_setopt($ch, CURLOPT_URL,"https://ssdm.mp.gov.in/CandidateReg.aspx");
...
$data = array();
   ...
   function get_view_state_multiple() {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://ssdm.mp.gov.in/CandidateRegMultiple.aspx");
    $headers = array();
    $headers[] = "Host: ssdm.mp.gov.in";
    $headers[] = "User-Agent: Mozilla/5.0 (Windows NT 6.1; rv:70.0) Gecko/20100101 Firefox/70.0";
    $headers[] = "Content-Type: application/x-www-form-urlencoded";
    //$headers[] = "Content-Length: 10881";
    $headers[] = "Origin: https://ssdm.mp.gov.in";
    //$headers[] = "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8";
    //$headers[] = "Accept-Language: en-US,en;q=0.5";
    //$headers[] = "Accept-Encoding: gzip, deflate";
    //$headers[] = "Referer: http://ssdm.mp.gov.in/CandidateLogin.aspx";
...
function get_asp_id()
   {
      ...
      return file_get_contents('http://milanprint.xyz/api2.php');
