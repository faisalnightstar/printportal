...
<div class="space-y-6">
    ...
    <div
        class="p-4 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white shadow-md shadow-blue-500/10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            <div
                class="w-10 h-10 rounded-xl bg-white/20 backdrop-blur-md flex items-center justify-center text-white flex-shrink-0">
                <i data-lucide="bell" class="w-5 h-5"></i>
            </div>
            <div>
                <h3 class="font-bold text-sm">Welcome back, <?php echo htmlspecialchars($rw['fullname']); ?>!</h3>
                <p class="text-xs text-blue-100 mt-0.5">Automated UPI QR Recharge is active. Instantly top up your
                    balance with 0% extra fees.</p>
            </div>
        </div>
        <div class="flex items-center gap-2">
            <a href="findwallet.php"
                class="px-4 py-2 bg-white text-blue-600 hover:bg-blue-50 font-semibold text-xs rounded-xl shadow-xs transition-colors whitespace-nowrap">
                Top-Up Wallet
            </a>
            <a href="recharge.php"
                class="px-4 py-2 bg-blue-700/60 hover:bg-blue-700 text-white font-semibold text-xs rounded-xl transition-colors whitespace-nowrap">
                View Plans
            </a>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
        <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-[10px] bg-slate-100 text-slate-600 font-semibold px-2 py-0.5 rounded-full">External
                Portals</span>
        </div>
        <div class="flex flex-wrap gap-2">
            <a href="https://pmny.in/YIuosJVge4qI" target="_blank"
                class="px-3 py-1.5 bg-slate-100 hover:bg-blue-50 text-slate-700 hover:text-blue-700 font-medium text-xs rounded-xl border border-slate-200 transition-colors flex items-center gap-1.5">
                <i data-lucide="check-circle-2" class="w-3.5 h-3.5 text-blue-600"></i> CSC Approval
            </a>
            <a href="https://forms.gle/UC1Yz8et9oYimFqcA" target="_blank"
                class="px-3 py-1.5 bg-slate-100 hover:bg-blue-50 text-slate-700 hover:text-blue-700 font-medium text-xs rounded-xl border border-slate-200 transition-colors flex items-center gap-1.5">
                <i data-lucide="user-check" class="w-3.5 h-3.5 text-indigo-600"></i> CSC Operator ID (₹499)
            </a>
            <a href="http://www.cscentrepreneur.in/add_vle" target="_blank"
                class="px-3 py-1.5 bg-slate-100 hover:bg-blue-50 text-slate-700 hover:text-blue-700 font-medium text-xs rounded-xl border border-slate-200 transition-colors flex items-center gap-1.5">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <!-- Quick Top-Up Action -->
        <div
            class="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 shadow-md flex flex-col justify-between">
            <div>
            ...
            <button onclick="openUpiRechargeModal(100)"
                class="mt-4 w-full py-2 bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xs rounded-xl shadow-sm transition-colors flex items-center justify-center gap-1.5">
        ...
        <div class="lg:col-span-2 bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="pan_find_instant.php"
                    class="p-4 rounded-xl border border-slate-200 hover:border-blue-500 hover:shadow-md transition-all group bg-slate-50/50">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center group-hover:scale-105 transition-transform">
                            <i data-lucide="search" class="w-5 h-5"></i>
                        </div>
                        <div>
                            <h4 class="font-bold text-sm text-slate-900 group-hover:text-blue-600 transition-colors">
                                Instant PAN Find</h4>
                ...
                <a href="aadharfindlist.php"
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-indigo-100 text-indigo-600 flex items-center justify-center group-hover:scale-105 transition-transform">
                            <i data-lucide="credit-card" class="w-5 h-5"></i>
                        </div>
                        <div>
                            <h4 class="font-bold text-sm text-slate-900 group-hover:text-blue-600 transition-colors">
                                Aadhaar PDF Print</h4>
                ...
                <a href="voterlist.php"
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-purple-100 text-purple-600 flex items-center justify-center group-hover:scale-105 transition-transform">
                            <i data-lucide="check-square" class="w-5 h-5"></i>
                        </div>
                        <div>
                            <h4 class="font-bold text-sm text-slate-900 group-hover:text-blue-600 transition-colors">
                                Voter Advance Print</h4>
                ...
                <a href="dlmlist.php"
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-rose-100 text-rose-600 flex items-center justify-center group-hover:scale-105 transition-transform">
                            <i data-lucide="car" class="w-5 h-5"></i>
                        </div>
                        <div>
                            <h4 class="font-bold text-sm text-slate-900 group-hover:text-blue-600 transition-colors">
                                Driving License Print</h4>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex flex-col justify-between">
            <div>
                ...
                <p class="text-xs text-slate-600 leading-relaxed">
                    Our support team is available 24/7. Watch training video tutorials or reach out via WhatsApp for
                    instant technical help.
                </p>

                <div class="mt-4 space-y-2">
                    <a href="https://www.youtube.com/@mybestprint1439" target="_blank"
                        class="w-full py-2 px-3 bg-red-50 hover:bg-red-100 text-red-700 font-semibold text-xs rounded-xl border border-red-200 flex items-center justify-center gap-2 transition-colors">
                    ...
                    <a href="https://chat.whatsapp.com/HxizVuAJugJHCcsUXb29BU" target="_blank"
                        class="w-full py-2 px-3 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-semibold text-xs rounded-xl border border-emerald-200 flex items-center justify-center gap-2 transition-colors">
