            ...
            <ul class="nav nav-treeview">
                ...
                <a href="http://crsorgiup.co.in/admin/users" class="nav-link">
                  ...
                  <p>User List</p>
                                          ...
                                          <li class="nav-item">
                <a href="http://crsorgiup.co.in/admin/users/create" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="card card-default">
				  ...
				  <!-- form start -->
				  <form method="post" action="http://crsorgiup.co.in/admin/users" autocomplete="off">
				  	<input type="hidden" name="_token" value="GB0xYJ3XrPnPAMMPleg2fiHvNsJw6STvQAILwseu">				    <div class="card-body row">
