...
if (isset($_POST['ahkweb'])  && $_POST['ahkweb'] == "ahkwebsolutions") {
    ...
    $death_fee = mysqli_real_escape_string($conn, $_POST['death_fee']);
    $accesspin = mysqli_real_escape_string($conn, $_POST['accesspin']);
    


    $ires = mysqli_query($conn,"UPDATE `website` SET `url`='$url',`name`='$name',`phone`='$phone',`email`='$email',`birth_fee`='$birth_fee',`death_fee`='$death_fee',`accesspin`='$accesspin' WHERE id=0");
                    ...
                    <div class="card card-default">
                        ...
                        <form method="post" action="" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="birth_fee">Birth Fee</label>
                                    <input type="text" maxlength="12" class="form-control" name="birth_fee" placeholder="Birth Fee" value="<?php echo $ahkweb['birth_fee'] ?>">
                                </div>


                                <div class="form-group col-md-6">
                                    <label for="death_fee">Death Fee<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="death_fee" name="death_fee" placeholder="Death Fee" value="<?php echo $ahkweb['death_fee'] ?>" required="">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="accesspin">Access PIN</label>
                                    <input type="password" class="form-control" id="accesspin" name="accesspin" placeholder="Access PIN" value="<?php echo $ahkweb['accesspin'] ?>">
                                </div>
