...
<link href="aadhar.css" type="text/css" rel="stylesheet">
   ...
   <?php 
  $sid = $_GET['searchid'];
  $get = mysqli_fetch_assoc(mysqli_query($connection,"select * from voterauto where id=".$sid.""));
...
if($get['add_by'] == 2) 
{
    ...
    <style>
	.firstpage {
    background-image: url(voterhindifrontdemo.jpg);
    height: 500px;
    ...
    .secondpage {
    background-image: url(voterhindibackdemo.jpg);
    height: 500px;
    background-size: contain;
    background-repeat: no-repeat;
    margin-right: 30px;
...
$a = mysqli_query($connection,"SELECT * FROM voterauto Where id='".$searchid."'");
