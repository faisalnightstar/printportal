12px<?php if (file_exists(__DIR__ . '/config.php')) {
...
<link href="assamvoter/aadhar.css" type="text/css" rel="stylesheet">
  ...
  <?php 
  $sid = $_GET['searchid'];
  $get = mysqli_fetch_assoc(mysqli_query($connection,"select * from voterphoto where voterautoid=".$sid.""));
...
<div class="settable">
<table class="tablecss" style="font-weight:bold;font-size:13px; margin-top:5px;">

<tbody><tr>
<td style="padding-bottom: 12px;"><?php echo $b['namelocal'];?>  </td>
</tr>
<tr>
<td style="padding-bottom: 12px;"> <?php echo $b['votername'];?></td>
</tr>
<tr>
<td style="padding-bottom: 12px;"> <?php echo $b['fathernamelocal']; ?></td>
</tr>
<tr>
    <td style="padding-bottom: 12px;"><?php echo $b['fathername'] ?></td>
</tr>
</tbody></table>
</div>
