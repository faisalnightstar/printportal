...
$a = mysqli_query($connection,"SELECT * FROM voter Where id='".$searchid."'");
$b = mysqli_fetch_array($a);
if ($b['language']==HI) { ?>
    <style>
	.firstpage { 
    background-image: url(hindi.png);
    height: 700px;
	...
	<?php } elseif($b['language']==PA) { ?>
	
	 <style>
	.firstpage { 
    background-image: url(PUNJABI.png);
    height: 700px;
    background-size: contain;
    background-repeat: no-repeat;
    margin-right: 30px;
    ...
    margin-bottom: 20px;
		...
		<?php } elseif($b['language']==GU) { ?>
	
	 <style>
	.firstpage { 
    background-image: url(GUJARATI.png);
    height: 700px;
    background-size: contain;
    background-repeat: no-repeat;
    margin-right: 30px;
	...
	</style>	<?php } elseif($b['language']==MR) { ?>
	
	 <style>
	.firstpage { 
    background-image: url(MARATHI.png);
    height: 700px;
    background-size: contain;
    background-repeat: no-repeat;
    margin-right: 30px;
	...
	</style>	<?php } elseif($b['language']==TA) { ?>
	
	 <style>
	.firstpage { 
    background-image: url(TAMIL_NADU.png);
    height: 700px;
    background-size: contain;
    background-repeat: no-repeat;
    margin-right: 30px;
	...
	</style>	<?php } elseif($b['language']==KN) { ?>
	
	 <style>
	.firstpage { 
    background-image: url(KANNDA.png);
    height: 700px;
    background-size: contain;
    background-repeat: no-repeat;
    margin-right: 30px;
	...
	</style>	<?php } elseif($b['language']==BN) { ?>
	
	 <style>
	.firstpage { 
    background-image: url(BENGALI.png);
    height: 700px;
    background-size: contain;
    background-repeat: no-repeat;
    margin-right: 30px;
    ...
    margin-bottom: 20px;
		...
		<?php }
		elseif($b['language']=="OR") { ?>
	
	 <style>
	.firstpage { 
    background-image: url(oriya.png);
    height: 700px;
    background-size: contain;
    background-repeat: no-repeat;
    margin-right: 30px;
...
?>
   ...
   <body>
      ...
      <main class="bg">
         <div class="row">
             <div class="firstpage">
                 <img src="barcode-306926_960_720.png" class="barcode">
                ...
                $aaaa =  $iparr[1];
                  ...
                  <div class="settable">
                       <table class="tablecss" style="font-weight:bold;font-size:14px">
                           <tr>
                               <td style="padding-bottom: 15px;"><?php echo $b['nameinlocal']; ?></td>
                           ...
                           <tr>
                               ...
                               <td style="padding-bottom: 15px;"><?php echo $b['guardianinlocal']; ?></td>
                               <td style="padding-bottom: 15px;"><?php echo ': '.$b['father_name_regional'] ?></td>
                           </tr>
                           <tr>
                               <td style="padding-bottom: 15px;"><?php echo ucfirst($b['relation_name'])."'s".' Name'?></td>
             ...
             <div class="secondpage">
                ...
                <div class="age">
                    ...
                    <span class="value">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; : <?php echo $b['age'].' '.$b[''] ?></span>
                ...
                <div class="address">
                    ...
                    <span class="value"><?php echo $b['original_address'].'-'.$b['pincode']; ?></span>
                </div>
