  ...
  <div class="row">
	...
	<td align="left" valign="left">   Sn.No.       </td>
								<thead>
									...
									<th style="color:#fff">   Aadhar No      </th>
									<th style="color:#fff">  Father's Name      </th>
									<th style="color:#fff">   Mother's Name      </th>
									...
									<tbody>
									 <?php 
                                        ...
                                        $q = "SELECT * FROM `panfind` WHERE 1 order by id desc";
                                        ...
                                        while($b = mysqli_fetch_array($a)){ ?>
                                          ...
                                          <td > <?php echo $x++;?> </td>
                                           ...
                                           <td > <?php echo $b['mothername'];?> </td>
                                            <td > <?php echo $b['mobileno'];?> </td>
                                           <td > <?php echo $b['date'];?> </td>
                                           <td > <?php echo $b['status'];?> </td>
                                           <td > <a class="btn btn-primary" href="panfindview.php?id=<?php echo $b['id'];?>" target="_blank">View</a> </td>
                                           ...
                                           <button class="btn btn-success" id="upload" data="" onclick="upload('<?php echo $b['id'];?>')">Upload</button>
                                            ...
                                            <?php }else {?>
                                                ...
                                                <form action="active-panfind.php" method="post" enctype="multipart/form-data" >												<input name="id" type="hidden" value="<?=$b['id']?>" />												<input style="margin-top:2px;margin-bottom:2px;padding-top:2px;padding-bottom:2px;" class="btn btn-info" type="submit" value="DELETE DATA" />											</form>	
                                            <?php } 
                                            ?>
...
function upload(id){
    ...
    $('#uploadcert').on('click',()=>{
        ...
        $.ajax({
        url: 'uploadpanfind.php', // point to server-side PHP script 
