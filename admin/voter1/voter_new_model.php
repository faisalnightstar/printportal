...
$searchid = mysqli_fetch_assoc(mysqli_query($connection, "select * from voterauto1 where voterautoid=" . $searchid . ""));
extract($searchid);
if($payment_status==1)
      ...
      <main class="bg">
         <div class="row">
             <div class="firstpage">
                ...
                <div class="epicnumberphoto font-bold"><?php echo $b['epicno'] ?></div>
				<?php if(strpos($b['imagepathoriginal'],'data:image') !== false) { ?>
