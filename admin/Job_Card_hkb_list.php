...
$s_phone=$rw['mobileno'];
$res = mysqli_query($connection, "SELECT * FROM `job_card` WHERE username='$s_phone' ORDER BY `id` DESC");
if(isset($_POST['delete']) && $_POST['delete'] == "del"){
    $id = base64_decode($_POST['id']);
    $del = mysqli_query($connection,"DELETE FROM `job_card` WHERE id='$id'");
    if($del){
        ?>
        <script>
            $(function(){
                ...
                <section class="section">
                    <div class="card-header bg-danger">
                        <div class="card-title">
                            <h3><strong>Job Card Print List </strong></h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        <table id="default-datatable" class="table table-bordered" width="100%">
                                            ...
                                            <thead style="color:white;background:linear-gradient(-62deg, #3a3a53, #03a9f4);">
                                                <tr>
                                                    ...
                                                    <th style="color:white">JOB No</th>
                                            ...
                                            <tbody>
                                                 <?php
                                                $sql = mysqli_query($connection, "SELECT * FROM job_card WHERE username='$s_phone' order by id DESC");
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><?php echo $slno; ?></td>
                                                            <td><?php echo $data['job_card_no']; ?></td>
                                                            <td><?php echo $data['date']; ?></td>
                                                            <td align="center" valign="middle">
                                                                <a href="<?php echo $data['pdf']; ?>" download="<?php echo $data['job_card_no']; ?>.pdf"><img src="pdf_doc.jpg" width="50" height="50" /></a>
                                                            </td>
                                                             
                                                            <td align="center" valign="middle">
                  											<form action="action_job_pdf.php" method="post" enctype="multipart/form-data" >
