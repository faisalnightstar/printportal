...
$a = mysqli_query($connection,"SELECT * FROM voterphoto Where voterautoid='".$searchid."'");
         ...
         <div class="row">
             <div class="firstpage">
                ...
                $aaaa =  $iparr[1];
                  ?>
                  <div class="settable">
                       <table class="tablecss" style="font-weight:bold;font-size:11px">
                           <tr>
                               <td style="padding-bottom: 20px;"><?php echo $aaaa ?></td>
                               <td style="padding-bottom: 20px;"><?php echo ': '.$b['namelocal'] ?></td>
                           </tr>
                           <tr>
                               <td style="padding-bottom: 20px;"><?php echo 'Name' ?></td>
                               <td style="padding-bottom: 20px;"><?php echo ': '.$b['votername'] ?></td>
                           </tr>
                           <tr>
                               <td style="padding-bottom: 20px;"><?php echo $b['spousenamelocal'].' '.$b['kaname'] ?></td>
                               <td style="padding-bottom: 20px;"><?php echo ': '.$b['fathernamelocal'] ?></td>
                           </tr>
                           <tr>
                               <td style="padding-bottom: 20px;"><?php echo $b['spousename'].' Name'?></td>
                               <td style="padding-bottom: 20px;"><?php echo ': '.$b['fathername'] ?></td>
                           </tr>
                       </table>
                  </div>
