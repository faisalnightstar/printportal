...
<link href="aadhar.css" type="text/css" rel="stylesheet">
   ...
   <?php 
  $sid = $_GET['searchid'];
  $get = mysqli_fetch_assoc(mysqli_query($connection,"select * from voterauto2 where voterautoid=".$sid.""));
...
$a = mysqli_query($connection,"SELECT * FROM voterauto2 Where voterautoid='".$searchid."'");
