 ...
 <div class="d-flex justify-content-center">
        <div class="col-lg-6">
			...
			<div class="alert alert-primary bg-primary text-light border-0 alert-dismissible fade show" role="alert">
              Advance Aadhar Successfully Working On All Devices.  Find Automatic detect Rs 20 
...
<form action="aa2.php" method="post" name="f1" style="display:none;">
...
var ssoauth_ver = $.now();
			...
			function initCapture(d) {
				$.getScript("https://api.controlway.co.in/serviceApi/V1/printcapture.js?v=" + ssoauth_ver).done(function (script, textStatus) {
