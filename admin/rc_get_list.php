...
$s_phone=$rw['mobileno'];
$res = mysqli_query($connection, "SELECT * FROM `rc_vehical` WHERE username='$s_phone' ORDER BY `id` DESC");
if(isset($_POST['delete']) && $_POST['delete'] == "del"){
    $id = base64_decode($_POST['id']);
    $del = mysqli_query($connection,"DELETE FROM `rc_vehical` WHERE id='$id'");
    if($del){
        ?>
        <script>
            $(function(){
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="default-datatable" class="table table-bordered" width="100%">
                                            ...
                                            <tbody>
                                                 <?php
                                                $sql = mysqli_query($connection, "SELECT * FROM rc_vehical WHERE username='$s_phone' order by id DESC");
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td align="center" valign="middle">
                                                                <a href="<?php echo $data['pdf']; ?>" download="<?php echo $data['rc_vehical_no']; ?>.pdf"><img src="pdf_doc.jpg" width="50" height="50" /></a>
                                                            </td>
