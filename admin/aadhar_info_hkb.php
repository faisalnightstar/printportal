...
$saltValue = $_SESSION['es_saltValue'];
    ...
    if ($findwallet >= $fee) {
       ...
       curl_setopt_array($curl, array(
          ...
          CURLOPT_POSTFIELDS => http_build_query(array('bioenc' => $bio,'aadhar' => $aadhar,'mobileNo'=>$mobileNo,'saltValue'=>$saltValue,'uida'=>$toknen,'api' => "CjtGHoUc-oaM6-nCcw-GjG9-sfpHS1wzYiHqoGU5")),
        ));
        ...
        if ($status === 'Success') {
            ...
            echo "<script>alert('Failed | $error_api')</script>";  // Data Not Fetched
        }
    } else {
