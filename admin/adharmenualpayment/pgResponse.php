...
$query = "UPDATE aadharmanual SET payment_status=1 WHERE aadharmanualid='$userid'";
...
echo $html
   ...
   <script>
            setTimeout(()=>{
                window.location.href="https://<?php echo $server=$_SERVER['SERVER_NAME'];?>/admin/aadharmanuallist.php";
            },2000);
        </script>
        <?php 
