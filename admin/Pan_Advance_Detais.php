                               ...
                               $sign_file = $sign_dir . basename($_FILES["signfile"]["name"]);
                                ...
                                if ($aadharno=="") {
                                   ...
                                   $msgno = 'Please Enter Pan Card No .... ';
                                        ...
                                        window.location.href= 'Pan_Advance_Detais.php';
...
$timestamp = date("Y-m-d H:i:s");
                                    ...
                                    $query = "insert into panauto(`userid`,`panno`,`name`,`fathername`,`dob`, `gender`,`image`,`signimage`,`create_time`)values(".$_SESSION['userid'].",'".$aadharno."','".$name."','".$fathername."','".$dobadhar."','".$gender."','".$target_file."','".$sign_file."','".$timestamp."')";
...
//echo    $query; 
                                   ...
                                   //echo $b['wamt'];
									...
									$sql = "update tbluser SET walletamount= walletamount - 20".$getpoint['aadharpoint']." where userid='".$_SESSION['userid']."'";
