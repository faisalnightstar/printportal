...
if(strtoupper($b['locallanguage']) == 'KN')
     {
          header("location:aadhar-kn?type=dbt&searchid=".$searchid);
          exit;
     }
else if(strtoupper($b['locallanguage']) == 'PA')
     {
          header("location:aadhar-pa?type=dbt&searchid=".$searchid);
          exit;
     }   
  
else if(strtoupper($b['locallanguage']) == 'GU')
     {
          header("location:aadhar-gu?type=dbt&searchid=".$searchid);
          exit;
     } 
     ...
     {
          header("location:aadhar-ta?type=dbt&searchid=".$searchid);
          exit;
     } 

else if(strtoupper($b['locallanguage']) == 'BN')
     {
          header("location:aadhar-bn?type=dbt&searchid=".$searchid);
          exit;
     }
else if(strtoupper($b['locallanguage']) == 'TE')
     {
          header("location:aadhar-te?type=dbt&searchid=".$searchid);
          exit;
     } 
else if(strtoupper($b['locallanguage']) == 'OR')
     {
          header("location:aadhar-or?type=dbt&searchid=".$searchid);
          exit;
     }                           
        ...
        <div class="pdf">
            <div class="left">
                <div class="one">
                    ...
                    <p> नामांकन क्रम / Enrollment No: 0649/27055/546<?php echo $b['srno']?> </p>
                    <div class="rtt">
