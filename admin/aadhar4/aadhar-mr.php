        ...
        <div class="pdf">
            <div class="left">
                <div class="one">
                    ...
                    <p> नामांकन अनुक्रम / Enrolment No: <?php echo $b['srno']?> </p>
                    <div class="rtt">
...
?>
                ...
                <div class="two">
                    <h4>आपला <span>आधार</span> क्रमांक / Your <span>Aadhaar</span> No. :</h4>
                    <h3><span><?php echo $b['originalaadharno']?></span></h3>
                    <h2>माझा <span>आधार</span>, माझी ओळख</h2>
                ...
                <div class="adhr">
                    ...
                    <div class="three">
                        <img src="images/mar2.jpg" class="img2">
                        <div class="a_lft">
        ...
        <?php } ?>
                    ...
                    <img src="images/Marathi.jpg" class="img7">
                </div>
            ...
            <div class="right">
                <div class="one">
                    ...
                    <div class="info">
                        ...
                        <ul>
                            ...
                            <li><span>आधार </span> ओळख प्रमाण, नागरिकांचा नाही.</li>
                            <li>ओळख प्रमाण ऑनलाइन ऑथेन्टिकेशन द्वारा प्राप्त करें.</li>
                            <li>हे इलेक्ट्रॉनिक प्रक्रिया करून तयार झालेले पत्र आहे</li>
                        </ul>
                        <h4>Information</h4>
                        <ul>
                    ...
                    <div class="info2">
                        <ul>
                            <li><span>आधार</span> देश भरात मान्यता  आहे |</li>
                            
                            <li><span>आधार</span> भविष्यात सरकारी व खाचंगी सेवांचे  <br><span class="brk"> फायदे मिळविण्यास उपयुक्त आहे .</span></li>
                ...
                <div class="adhr adhr2">
                    <img src="img/cut.png" class="cut">
                    <div class="three">
                        <img src="images/mar3.jpg" class="img2">
                        <div class="b_lft">
                            <ul>
                                <li><span>पत्ता:</span></li>
