...
$query = "UPDATE panfind SET payment_status=1, status='In Progress' WHERE id='$userid'";
...
echo $html
   ...
   <script>
            setTimeout(()=>{
                window.location.href="https://<?php echo $server=$_SERVER['SERVER_NAME'];?>/admin/panfindlist.php";
            },2000);
        </script>
        <?php 
