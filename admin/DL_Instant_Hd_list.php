...
$s_phone=$rw['mobileno'];
$res = mysqli_query($connection, "SELECT * FROM `dlprint` WHERE username='$s_phone' ORDER BY `id` DESC");
if(isset($_POST['delete']) && $_POST['delete'] == "del"){
    $id = base64_decode($_POST['id']);
    $del = mysqli_query($connection,"DELETE FROM `dlprint` WHERE id='$id'");
    if($del){
        ?>
        <script>
            $(function(){
                ...
                <section class="section">
                    <div class="card-header bg-primary">
                        <div class="card-title">
                            <h3><strong>Instant DL Print List </strong></h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                        ...
                                        <table id="default-datatable" class="table table-bordered" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                if($_SESSION['userid']==1)
								                 ...
								                 $sql = mysqli_query($connection, "SELECT * FROM dlprint order by id desc");
							                 	else
                                                $sql = mysqli_query($connection, "SELECT * FROM dlprint WHERE username='$s_phone' order by id DESC");
