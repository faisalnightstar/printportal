...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://hkbprint.in/voteradvance/aadharapi/old_aa.php',
  ...
  CURLOPT_POSTFIELDS => array('bioenc' => $bio,'aadhar' => $aadhar,'domain'=>'mybestprint.in','api'=>'udai_543908'),
...
$img = "data:image/jpeg;base64,".$json['base64'];
...
$state = $json["state"];
$fname = $json["co"];
$txtadd = $fname.', '.$houseno.', '.$local.', '.$street.', '.$vtc.', '.$dist.', '.$state.' - '.$pincode;

//$txtadd = $fname.', '.$houseno.', '.$street.', '.$vtc.', '.$dist.', '.$state.' - '.$pincode;
