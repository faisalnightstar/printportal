...
<body class="bg-gray-50 text-gray-800 font-sans antialiased flex flex-col min-h-screen">
    ...
    <div class="bg-gradient-to-b from-brand-dark to-slate-800 py-12 border-t border-slate-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
            <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-4 tracking-tight text-center">Cancellation & Refund Policy</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mt-8">
                ...
                <div class="flex space-x-4 mt-6 md:mt-0 text-sm">
                    ...
                    <a href="refund-policy.php" class="text-brand-light transition-colors font-medium">Refund/Cancellation</a>
