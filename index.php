...
<head>
    ...
    <!-- SEO & Geo-Targeting -->
    <title>Print Portals | Fast & Secure Document Printing Services</title>
    <meta name="description" content="Professional document printing portal in India. Access instant PVC printing for Aadhaar, Voter ID, PAN, Ayushman, and Driving License. Fast, secure, and reliable.">
    <meta name="keywords" content="Print Portals, Aadhaar Print, Voter ID Print, PVC Card Printing, PAN Card Print, Ayushman Card Print, Digital Print Portal India">
    <meta name="author" content="Print Portals">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    <link rel="canonical" href="https://printportals.xyz/" />
    <meta name="google-site-verification" content="hcl-Jqwp1MOp5NPH7w34dDulCYYH3haxX4MmAacpdDs" />
    
    <!-- Open Graph / Social Media Meta Tags -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://printportals.xyz/">
    <meta property="og:title" content="Print Portals | Fast & Secure Document Printing Services">
    <meta property="og:description" content="Professional document printing portal in India. Access instant PVC printing for Aadhaar, Voter ID, PAN, Ayushman, and Driving License.">
    <meta property="og:image" content="https://printportals.xyz/images/og-image.jpg">
    
    <!-- Twitter Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta property="twitter:domain" content="printportals.xyz">
    <meta property="twitter:url" content="https://printportals.xyz/">
    <meta name="twitter:title" content="Print Portals | Fast & Secure Document Printing">
    <meta name="twitter:description" content="Professional document printing portal in India. Access instant PVC printing for Aadhaar, Voter ID, PAN, and more.">
    <meta name="twitter:image" content="https://printportals.xyz/images/og-image.jpg">
    ...
    <!-- Google AdSense -->
    <meta name="google-adsense-account" content="ca-pub-6368432316511725">
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6368432316511725" crossorigin="anonymous"></script>
...
<body class="bg-gray-50 text-gray-800 font-sans antialiased flex flex-col min-h-screen">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NMV2S4GV" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <nav class="bg-brand-dark sticky top-0 z-50 shadow-md">
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-6">
                        <a href="/" class="text-white hover:text-brand-accent px-3 py-2 rounded-md text-sm font-medium transition-colors">Home</a>
        ...
        <div class="hidden md:hidden bg-brand-light" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="/login.php" class="text-brand-accent block px-3 py-2 font-bold">Login</a>
                <a href="/register.php" class="bg-brand-accent text-white block px-3 py-2 rounded-md font-bold mt-2">Register</a>
            </div>
        </div>
    </nav>

    <!-- Important Notice Banner (Replaces Marquee) -->
    <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 shadow-sm" role="alert">
        <div class="max-w-7xl mx-auto flex items-start sm:items-center">
            <svg class="w-6 h-6 mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
            <p class="text-sm sm:text-base font-medium">
                <strong>महत्वपूर्ण सूचना:</strong> यह पोर्टल केवल आपको दस्तावेज़ प्रिंट करने की सुविधा प्रदान करता है। किसी भी प्रकार के सुधार या बदलाव के लिए हम जिम्मेदार नहीं हैं। यह वेबसाइट केवल आपकी स्वेच्छा से PVC कार्ड प्रिंटिंग का कार्य करती है।
            </p>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed">
                    The ultimate platform for CSC VLEs and retailers. Instantly print Aadhaar, Voter IDs, PAN cards, Ayushman cards, and more with our fast, secure, and highly reliable digital portal.
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="/register.php" class="bg-brand-accent text-white hover:bg-emerald-400 font-bold py-3 px-8 rounded-lg shadow-lg transition-transform transform hover:-translate-y-1 text-center">Create Free Account</a>
                    <a href="/login.php" class="bg-transparent border-2 border-white hover:bg-white hover:text-brand-dark text-white font-bold py-3 px-8 rounded-lg shadow-lg transition-all text-center">Login to Portal</a>
                </div>
            </div>
            <div class="hidden lg:flex justify-center">
                <!-- Using a highly professional placeholder SVG illustration instead of missing local image -->
                <svg class="w-full max-w-md opacity-90" viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="50" y="80" width="400" height="260" rx="12" fill="#3b82f6" stroke="#10b981" stroke-width="4"/>
                    ...
                    <path d="M415 360 L425 370 L445 350" stroke="#10b981" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
        </div>
    </div>
    ...
    <div class="py-16 bg-gray-50 flex-grow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">Our Premium Services</h2>
                <p class="mt-4 text-xl text-gray-600">Everything you need to serve your customers efficiently in one portal.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                
                <!-- Service 1 -->
                <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    <div class="w-14 h-14 bg-brand-light rounded-lg flex items-center justify-center mb-6">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2"></path></svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Advanced Aadhaar Print</h3>
                    <p class="text-gray-600 leading-relaxed">Print Aadhaar cards without OTP. Use simple Aadhaar Number and Biometric Authentication for instant PVC formatting.</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Ayushman Card Print</h3>
                    <p class="text-gray-600 leading-relaxed">Quickly print Ayushman Cards using Biometric Authentication, PMJAY ID, Family ID, or registered Mobile Number.</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">RTPS Services</h3>
                    <p class="text-gray-600 leading-relaxed">Directly print or download essential documents like Domicile, Residential, and Income Certificates through our portal.</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Advanced Voter Card</h3>
                    <p class="text-gray-600 leading-relaxed">Format and print Voter ID cards effortlessly without OTP, requiring only a simple EPIC number for retrieval.</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Driving License</h3>
                    <p class="text-gray-600 leading-relaxed">Retrieve and format Driving Licenses for PVC printing using just the Driving License number via our ePrintSeva integration.</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">PAN Card Services</h3>
                    <p class="text-gray-600 leading-relaxed">Lost PAN card? Find it using an Aadhaar number and generate a print-ready PAN Card PDF directly on our portal.</p>
                </div>
    ...
    <button id="chat-toggle-btn" onclick="toggleChat()" class="fixed bottom-6 right-6 bg-brand-accent text-white p-4 rounded-full shadow-2xl hover:bg-emerald-400 transition-all transform hover:scale-110 z-50 flex items-center justify-center">
    ...
    <!-- AI Chatbot Window -->
    <div id="chat-window" class="fixed bottom-24 right-6 w-[90vw] sm:w-96 bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden z-50 transition-all duration-300 origin-bottom-right scale-0 opacity-0 pointer-events-none border border-gray-200">
        <!-- Chat Header -->
        <div class="bg-brand-dark text-white p-4 flex justify-between items-center shadow-md z-10">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h3 class="font-bold text-sm">Portal Assistant</h3>
                    <p class="text-xs text-brand-accent">Powered by AI</p>
                </div>
            </div>
        ...
        <!-- Chat Messages Area -->
        <div id="chat-messages" class="h-80 overflow-y-auto p-4 bg-gray-50 flex flex-col gap-4 text-sm scroll-smooth">
            <!-- Greeting Message -->
            <div class="flex items-start gap-2 max-w-[85%]">
                ...
                <div class="bg-white border border-gray-200 text-gray-800 p-3 rounded-2xl rounded-tl-none shadow-sm">
                    Namaste! I am the Print Portals Assistant. How can I help you with Aadhaar, Voter ID, or PAN card printing today? 
                </div>
            </div>
        </div>
        ...
        <div class="p-3 bg-white border-t border-gray-200 flex gap-2">
            <input type="text" id="chat-input" placeholder="Type your question..." class="flex-grow px-4 py-2 bg-gray-100 border-transparent rounded-full focus:bg-white focus:border-brand-light focus:ring-2 focus:ring-brand-light outline-none transition-all text-sm" onkeypress="handleKeyPress(event)">
            <button onclick="sendMessage()" class="bg-brand-dark text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-brand-light transition-colors shadow-sm flex-shrink-0">
    ...
    <script>
        ...
        2. You can speak English and Hindi. Reply in the language the user uses.
        3. Constantly remind users that this portal is ONLY for formatting and printing documents they already have access to. It CANNOT be used to make corrections (name change, DOB change) to official government documents.
